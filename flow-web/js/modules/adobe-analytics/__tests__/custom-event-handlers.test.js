...
import * as adobeEvents from '../custom-event-handlers';
import setupAnalyticsEvent from '../custom-event-handlers';
...
describe('custom-events.js', () => {
  ...
  describe('adobeEventHandlers', () => {
    ...
    describe('will call adobe correctly for', () => {
      it.each([
        {
          alias: 'product_summary_card_buy_link_click',
          name: 'Product Summary Card Buy Link Click',
          label: 'product_summary_card_buy_link_label',
          event: 'event93',
        },
        {
          alias: 'product_body_buy_link_click',
          name: 'Product Body Buy Link Click',
          label: 'product_body_buy_link_label',
          event: 'event93',
        },
        {
          alias: 'comparison_carousel_buy_link_click',
          name: 'Comparison Carousel Buy Link Click',
          label: 'comparison_carousel_buy_link_label',
          event: 'event93',
        },
        {
          alias: 'compare_modal_buy_link_click',
          name: 'Compare Modal Buy Link Click',
          label: 'compare_modal_buy_link_label',
          event: 'event93',
        },
        {
          alias: 'comparison_carousel_read_review_link_click',
          name: 'Comparison Carousel/Modal Read Review Link Click',
          label: 'comparison_carousel_read_review_link_label',
          event: 'event99',
        },
        {
          alias: 'comparison_carousel_checkbox_click',
          name: 'Comparison Carousel Checkbox Click',
          label: 'comparison_carousel_checkbox_label',
          event: 'event100',
        },
        {
          alias: 'compare_modal_popup',
          name: 'Compare Table Pop-up',
          label: 'compare_modal_label',
          event: 'event101',
        },
      ])('$alias', ({ alias, label, name, event }) => {
        adobeEvents.adobeEventHandlers[alias]({
          [label]: label,
        });

        expect(trackCustomEvent).toHaveBeenCalledWith(
          name,
          { eVar42: label, prop42: 'D=v42' },
          [event],
        );
      });
    });
