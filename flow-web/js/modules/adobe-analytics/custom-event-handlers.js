...
export const adobeEventHandlers = {
  ...
  product_summary_card_buy_link_click: (data) => {
    track(
      'Product Summary Card Buy Link Click',
      {
        [adobeVars.LINK_LABEL]: data.product_summary_card_buy_link_label,
        [adobeProps.LINK_LABEL]: makeEVarLink(adobeVars.LINK_LABEL),
      },
  ...
  product_body_buy_link_click: (data) => {
    track(
      'Product Body Buy Link Click',
      {
        [adobeVars.LINK_LABEL]: data.product_body_buy_link_label,
        [adobeProps.LINK_LABEL]: makeEVarLink(adobeVars.LINK_LABEL),
      },
      [adobeEvents.BUY_NOW_CLICK],
    );
  ...
  price_comparison_buy_link_click: (data) => {
    track(
      'Price Comparison Buy Link Click',
      {
        [adobeVars.LINK_LABEL]: data.price_comparison_buy_link_label,
        [adobeProps.LINK_LABEL]: makeEVarLink(adobeVars.LINK_LABEL),
      },
      [adobeEvents.BUY_NOW_CLICK],
    );
  ...
  comparison_carousel_buy_link_click: (data) => {
    track(
      'Comparison Carousel Buy Link Click',
      {
        [adobeVars.LINK_LABEL]: data.comparison_carousel_buy_link_label,
        [adobeProps.LINK_LABEL]: makeEVarLink(adobeVars.LINK_LABEL),
      },
      [adobeEvents.BUY_NOW_CLICK],
    );
  ...
  compare_modal_buy_link_click: (data) => {
    track(
      'Compare Modal Buy Link Click',
      {
        [adobeVars.LINK_LABEL]: data.compare_modal_buy_link_label,
        [adobeProps.LINK_LABEL]: makeEVarLink(adobeVars.LINK_LABEL),
      },
      [adobeEvents.BUY_NOW_CLICK],
    );
  ...
  comparison_carousel_read_review_link_click: (data) => {
    track(
      'Comparison Carousel/Modal Read Review Link Click',
      {
        [adobeVars.LINK_LABEL]: data.comparison_carousel_read_review_link_label,
        [adobeProps.LINK_LABEL]: makeEVarLink(adobeVars.LINK_LABEL),
      },
      [adobeEvents.INDYBEST_MODAL_READ_REVIEW_LINK_CLICK],
    );
  },

  comparison_carousel_checkbox_click: (data) => {
    track(
      'Comparison Carousel Checkbox Click',
      {
        [adobeVars.LINK_LABEL]: data.comparison_carousel_checkbox_label,
        [adobeProps.LINK_LABEL]: makeEVarLink(adobeVars.LINK_LABEL),
      },
      [adobeEvents.INDYBEST_COMPARE_CHECKBOX_SELECTED],
    );
  },

  compare_modal_popup: (data) => {
    track(
      'Compare Table Pop-up',
      {
        [adobeVars.LINK_LABEL]: data.compare_modal_label,
        [adobeProps.LINK_LABEL]: makeEVarLink(adobeVars.LINK_LABEL),
      },
      [adobeEvents.INDYBEST_COMPARE_TABLE_POPUP_SHOWN],
    );
  },
