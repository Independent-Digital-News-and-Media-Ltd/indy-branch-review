    ...
    addPageLevelTracking({
      ...
      events: [
        ...
        ...(digitalData.homepage_section
          ...
          : []),
        /**
         * @todo remove when removing COOKIE_FEAT_NO_AMP_PRODUCTS as this is
         * inferred within the preprocessor
         * @see @app/services/preprocessors/preprocess-products.js
         **/
        ...(document.querySelector(`.${CLASS_JS_PRODUCT_COMPARISON}`)
          ? [adobeEvents.PRODUCT_CAROUSEL_LOADED]
          : []),
      ],
    });
  }
