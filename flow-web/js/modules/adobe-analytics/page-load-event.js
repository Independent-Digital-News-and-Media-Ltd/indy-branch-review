...
import { getDigitalDataByKeys } from './digital-data';
...
const buildPageGenericTracking = (path) => {
  const {
    ...
    components_list,
    commercial_campaign,
    gigya_logged_in_status,
    gigya_uid,
    gigya_registration_date,
    gigya_user_status,
    gigya_demographics,
    gigya_sign_on_provider,
    just_logged_in,
    template_version,
  } = digitalData;
  ...
  addPageLevelTracking({
    events: [
      ...
      ...(just_logged_in ? [adobeEvents.SIGN_IN] : []),
    ],
    props: {
      ...
      [adobeVars.USER_LOGGED_IN_STATUS]: gigya_logged_in_status,
      [adobeVars.USER_ID]: gigya_uid,
      [adobeVars.USER_REG_DATE]: gigya_registration_date,
      [adobeVars.USER_STATUS]: gigya_user_status,
      ...
      [adobeProps.TEMPLATE_VERSION]: template_version,
      ...
      [adobeProps.USER_DEMOGRAPHICS]: gigya_demographics,
      [adobeProps.USER_SIGN_ON_PROVIDER]: gigya_sign_on_provider,
    ...
    addPageLevelTracking({
      ...
      events: [
        ...
        ...(digitalData.homepage_section
          ...
          : []),
        ...(document.querySelector('.js-product-comparison')
          ? [adobeEvents.INDYBEST_CAROUSEL_COMPARISON_CARD_LOADED]
          : []),
      ],
    });
  }
