...
import { COOKIE_FEAT_SELLING_PAGE_REDESIGN } from '@app/constants/cookies';
  ...
  [
    '/subscribe',
    {
      ...
      featureModeVariants: {
        ...
        [SELLING_PAGE_VARIANT_ONE]: 'Subscribe - Redesign',
        [SELLING_PAGE_VARIANT_TWO]: 'Subscribe - Redesign',
      },
    },
  ],
  ['/subscribe/app', { name: 'Subscribe - App' }],
  ['/subscribe/our-story', { name: 'Subscribe - Our Story' }],
  ['/web-push', { name: 'Web notification Landing Page' }],
