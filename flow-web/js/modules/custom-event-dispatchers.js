...
import { storeDigitalData } from './adobe-analytics/digital-data/digital-data-session';
...
export const dispatchProductSummaryCardBuyLinkClick = (data = {}) =>
  dispatchCustomEvent('product_summary_card_buy_link_click', data);

export const dispatchProductBodyBuyLinkClick = (data = {}) =>
  dispatchCustomEvent('product_body_buy_link_click', data);

export const dispatchPriceComparisonBuyLinkClick = (data = {}) =>
  dispatchCustomEvent('price_comparison_buy_link_click', data);

export const dispatchComparisonCarouselReadReviewLinkClick = (data = {}) =>
  dispatchCustomEvent('comparison_carousel_read_review_link_click', data);

export const dispatchComparisonCarouselCheckboxClick = (data = {}) =>
  dispatchCustomEvent('comparison_carousel_checkbox_click', data);

export const dispatchCompareModalPopup = (data = {}) =>
  dispatchCustomEvent('compare_modal_popup', data);

export const dispatchComparisonCarouselBuyLinkClick = (data = {}) =>
  dispatchCustomEvent('comparison_carousel_buy_link_click', data);

export const dispatchCompareModalBuyLinkClick = (data = {}) =>
  dispatchCustomEvent('compare_modal_buy_link_click', data);
