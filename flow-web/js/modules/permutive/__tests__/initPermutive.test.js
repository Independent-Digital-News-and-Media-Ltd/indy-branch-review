...
describe('initPermutive.js unit tests', () => {
  ...
  describe('eventBestProductClick', () => {
    ...
    describe('passConsentToPermutive()', () => {
      ...
      it('will not call Permutive consent method if jsglobals config is undefined', () => {
        mockPermutiveConsentMethod();
        initPermutive.passConsentToPermutive(mockConsent, mockConsentString);
        expect(window.permutive.consent).not.toHaveBeenCalled();
        expect(console.error).not.toHaveBeenCalled();
      });

      it('will not call Permutive consent method if consent is false', () => {
      ...
      it('will call Permutive consent method and other modules if consent and jsglobals config are both truthy', () => {
