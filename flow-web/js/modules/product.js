...
import {
  dispatchProductSummaryCardBuyLinkClick,
  dispatchProductBodyBuyLinkClick,
  dispatchPriceComparisonBuyLinkClick,
...
class Product {
  constructor(el, config = {}) {
    ...
    this.events = {
      summaryBuyLinkClick: this.handleSummaryBuyLinkClick.bind(this),
  ...
  handleSummaryBuyLinkClick() {
    dispatchProductSummaryCardBuyLinkClick({
      product_summary_card_buy_link_label:
  ...
  handleBodyBuyLinkClick() {
    dispatchProductBodyBuyLinkClick({
      product_body_buy_link_label: 'Product Body - Buy Link Click',
    });
  }

  handlePriceComparisonBuyLinkClick() {
    dispatchPriceComparisonBuyLinkClick({
      price_comparison_buy_link_label: 'Price Comparison - Buy Link Click',
    });
  }
