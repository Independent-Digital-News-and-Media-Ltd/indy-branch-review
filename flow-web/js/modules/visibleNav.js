...
const visibleNav = () => {
  ...
  menuItems.forEach((item, i) => {
    ...
    const triggerText = document.createTextNode(link.textContent);
  ...
  document.getElementById(ID_FRAMEINNER).addEventListener('click', closeOthers);
