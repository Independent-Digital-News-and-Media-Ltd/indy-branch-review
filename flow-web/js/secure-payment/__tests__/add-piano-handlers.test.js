...
import { removeDigitalDataByKeys } from '@app/public/js/modules/adobe-analytics/digital-data/digital-data-session';
...
jest.mock(
  '@app/public/js/modules/adobe-analytics/digital-data/digital-data-session',
);
