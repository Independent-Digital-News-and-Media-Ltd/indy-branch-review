...
const contributorAutoRenewToggle =
  document.getElementById(ID_AUTO_RENEW_TOGGLE);
...
const setIsSubscribedButtonVisibility = (isSubscribed) => {
...
const updateAutoRenew = async (autoRenew, subscriptionId) => {
...
if (contributorAutoRenewToggle) {
  contributorAutoRenewToggle.addEventListener('click', async (e) => {
    ...
    const autoRenewValue = e.target.checked;
