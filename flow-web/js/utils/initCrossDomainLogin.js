...
export const initIframe = (domain) => {
...
export const getLoginWithDomain = (iframeCache) => (domain, email, password) =>
  new Promise((resolve) => {
...
export const getDoLoginForEachDomain = (domains) => async (email, password) => {
