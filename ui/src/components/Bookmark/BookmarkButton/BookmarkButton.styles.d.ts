...
/// <reference types="react" />
export declare const StyledBookmarkButton: import("styled-components").IStyledComponent<"web", {
...
export declare const BookmarkIcon: import("styled-components").IStyledComponent<"web", {
    [x: string]: any;
    svg: any;
}> & {
    ({ svg, ...rest }: {
