...
/// <reference types="react" />
export declare const StyledBookmarkModal: import("styled-components").IStyledComponent<"web", {
    onEscapeKeyPress?: ((event?: unknown) => unknown) | undefined;
    className?: string | undefined;
    role?: string | undefined;
    children: import("react").ReactNode;
    isHidden?: boolean | undefined;
    returnFocus: string;
    onBackgroundClick?: ((event: unknown) => unknown) | undefined;
}> & import("react").FC<import("../../Modal/PageSpecific/ModalPageSpecific.types").PageSpecificProps>;
...
export declare const CloseButton: import("styled-components").IStyledComponent<"web", {
...
export declare const CloseIcon: import("styled-components").IStyledComponent<"web", {
    [x: string]: any;
    svg: any;
}> & {
    ({ svg, ...rest }: {
