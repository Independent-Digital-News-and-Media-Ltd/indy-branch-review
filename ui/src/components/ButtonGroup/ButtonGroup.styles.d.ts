...
export const List: import("styled-components").IStyledComponent<"web", {
...
export const ItemIcon: import("styled-components").IStyledComponent<"web", {
    [x: string]: any;
    svg: any;
}> & {
    ({ svg, ...rest }: {
...
export const Chevron: import("styled-components").IStyledComponent<"web", {
    [x: string]: any;
    svg: any;
}> & {
    ({ svg, ...rest }: {
...
/** @todo: replace with correct semantic name for the color and bg */
export const Item: import("styled-components").IStyledComponent<"web", {
