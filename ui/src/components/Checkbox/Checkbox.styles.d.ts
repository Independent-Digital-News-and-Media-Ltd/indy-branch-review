...
import { HiddenInputProps, LabelProps, WrapperProps } from './Checkbox.types';
export declare const HiddenInput: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").Substitute<import("react").DetailedHTMLProps<import("react").InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>, HiddenInputProps>>;
