...
export declare const Link: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").Substitute<(Omit<import("../Button/Button.types").ButtonType, "ref"> | Omit<import("../Button/Button.types").LinkType, "ref">) & import("react").RefAttributes<HTMLButtonElement>, import("styled-components/dist/types").BaseObject>> & import("react").ForwardRefExoticComponent<(Omit<import("../Button/Button.types").ButtonType, "ref"> | Omit<import("../Button/Button.types").LinkType, "ref">) & import("react").RefAttributes<HTMLButtonElement>>;
