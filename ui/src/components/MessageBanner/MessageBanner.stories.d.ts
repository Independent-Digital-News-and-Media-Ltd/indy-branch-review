...
declare const _default: {
    title: string;
    component: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").FastOmit<BaseProps, never>> & Omit<import("react").FC<BaseProps>, keyof import("react").Component<any, {}, any>>;
    argTypes: {
        messageTimeout: {
            description: string;
            control: {
