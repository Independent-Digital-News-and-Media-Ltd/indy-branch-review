...
export declare const Default: {
    args: {
        children: string;
        isHidden: boolean;
        Wrapper: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").FastOmit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, never>>;
        returnFocus: string;
    };
};
