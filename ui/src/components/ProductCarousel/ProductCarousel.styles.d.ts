...
export declare const PrevButton: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").FastOmit<import("../IconButton/IconButton.types").IconButtonProps, never>> & Omit<import("react").FC<import("../IconButton/IconButton.types").IconButtonProps>, keyof import("react").Component<any, {}, any>>;
export declare const NextButton: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").FastOmit<import("../IconButton/IconButton.types").IconButtonProps, never>> & Omit<import("react").FC<import("../IconButton/IconButton.types").IconButtonProps>, keyof import("react").Component<any, {}, any>>;
