...
import { doesMatch, hasMin, hasMax, hasRange, containsNoSpaces, matchesRegex, hasCustomValidation } from './schemaFunctions';
/**
...
declare class SchemaEntry {
     ...
     * @returns SchemaEntry
     */
    hasCustomValidation(...params: Parameters<typeof hasCustomValidation>): SchemaEntry;
}
